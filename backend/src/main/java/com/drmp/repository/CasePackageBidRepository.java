...
public interface CasePackageBidRepository extends JpaRepository<CasePackageBid, Long> {
     ...
     */
    boolean existsByCasePackageIdAndDisposalOrgId(Long casePackageId, Long disposalOrgId);
    
    /**
     * Find all bids for a case package
     */
    List<CasePackageBid> findByCasePackageId(Long casePackageId);
    
    /**
     * Find bids by disposal organization
     */
    Page<CasePackageBid> findByDisposalOrgId(Long disposalOrgId, Pageable pageable);
